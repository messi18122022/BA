...
CSV_FILE = "Van-Deemter/Kationentauscher/Ergebnisse_Retentionszeiten_Peakbreiten.csv"
# Säulenlänge L in mm
COLUMN_LENGTH = 150
...
def main():
    ...
    fit_and_plot(u, H_tot, "Van Deemter: mit Säule", 
                 os.path.join("Van-Deemter/Kationentauscher", "vd_mit_saeule.pdf"))
    ...
    fit_and_plot(u, H_ext, "Van Deemter: ohne Säule", 
                 os.path.join("Van-Deemter/Kationentauscher", "vd_ohne_saeule.pdf"))
    ...
    fit_and_plot(u, H_col, "Van Deemter: korrigiert", 
                 os.path.join("Van-Deemter/Kationentauscher", "vd_korrigiert.pdf"))
    ...
    plt.grid(True, zorder=0)
    plt.tight_layout()
    plt.savefig(os.path.join("Van-Deemter/Kationentauscher", "Balken_Retentionszeiten.pdf"))
    plt.close()
    ...
    plt.grid(True, zorder=0)
    plt.tight_layout()
    plt.savefig(os.path.join("Van-Deemter/Kationentauscher", "Balken_Peakbreiten.pdf"))
    plt.close()
